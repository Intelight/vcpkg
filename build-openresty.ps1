...
& 'C:\Program Files\Microsoft Visual Studio\18\Community\Common7\Tools\Launch-VsDevShell.ps1' -SkipAutomaticLocation -Arch amd64
...
.\luarocks.bat install tableshape 2.6.0-1
...
tar xf .\openresty\zips\openresty-1.27.1.2-win64.zip --strip-components=1 -C "$openresty"
